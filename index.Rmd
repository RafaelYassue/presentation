...
` \begin{align*}
%\label{eq1}
\mathbf{y}_{t} = \mathbf{1}\mu + \mathbf{X}_{1}\mathbf{r} + \mathbf{X}_{2}\mathbf{b} +   \mathbf{Z}_{1}\mathbf{m}+ \boldsymbol{\epsilon}
\end{align*}` 

$\mathbf{m}$ $\sim$ N (0, $\Sigma_{g} \otimes \mathbf{M}$) 

$\boldsymbol{\epsilon}$ $\sim$ N (0, $\Sigma_{\epsilon} \otimes \mathbf{I}$) the residual; 

$\otimes$ is the Kronecker product;a
...
```
<p style="font-family: times, serif; font-size:11pt; font-style:italic">
Figure. Thermal image processing analysis. Stitched image, plot detection, and local coordinates. 
</p>
